import { Generation, MoveCategory, NatureName, StatID, StatsTable, TypeName, Weather } from './interface';
...
export declare function handleFixedDamageMoves(attacker: Pokemon, move: Move, defender: Pokemon): number;
