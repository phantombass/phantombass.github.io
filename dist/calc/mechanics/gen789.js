...
function calculateSMSSSV(gen, attacker, defender, move, field) {
    ...
    (0, util_mech_1.checkMindGames)(gen, attacker, defender);
    (0, util_mech_1.checkMindGames)(gen, defender, attacker);
    (0, util_mech_1.checkMedusoid)(gen, attacker, defender);
    (0, util_mech_1.checkMedusoid)(gen, defender, attacker);
    ...
    if ((defender.hasAbility('Wonder Guard') && typeEffectiveness <= 1) ||
        ...
        (move.hasType('Water') && defender.hasAbility('Dry Skin', 'Storm Drain', 'Water Absorb', 'Steam Engine', 'Water Compaction')) ||
...
function calculateBasePowerSMSSSV(gen, attacker, defender, move, field, hasAteAbilityTypeChange, desc) {
    ...
    switch (move.name) {
        ...
        case 'Rising Voltage':
            ...
            break;
        case 'Rolling Fog':
            basePower = move.bp * (((0, util_mech_1.isGrounded)(defender, field) && field.hasTerrain('Misty')) ? 2 : 1);
            desc.moveBP = basePower;
            break;
        case 'Fling':
...
function calculateBPModsSMSSSV(gen, attacker, defender, move, field, desc, basePower, hasAteAbilityTypeChange, turnOrder) {
    ...
    if ((move.named('Facade') && attacker.hasStatus('brn', 'par', 'psn', 'tox', 'frz')) ||
        ...
        (move.named('Misty Explosion') && (0, util_mech_1.isGrounded)(attacker, field) && field.hasTerrain('Misty')) ||
        (move.named('PsyBlade') && (0, util_mech_1.isGrounded)(attacker, field) && field.hasTerrain('Electric')) ||
    ...
    var isFieldFeverPitch = field.isFeverPitch && move.type === 'Poison';
    var auraActive = isAttackerAura || isDefenderAura || isFieldFairyAura || isFieldDarkAura || isFieldGaiaForce || isFieldFeverPitch;
