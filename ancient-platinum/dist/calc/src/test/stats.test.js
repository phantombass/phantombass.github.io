...
describe('Stats', function () {
    ...
    test('gen 2 modifications', function () {
        expect((0, util_mech_1.getModifiedStat)(158, -1, data_1.Generations.get(2))).toBe(104);
        expect((0, util_mech_1.getModifiedStat)(238, -1, data_1.Generations.get(2))).toBe(157);
    });
});
