...
export type GameType = 'Singles' | 'Doubles' | 'Inverse';
export type Terrain = 'Electric' | 'Grassy' | 'Psychic' | 'Misty' | 'Poison';
export type Weather = 'Sand' | 'Sun' | 'Rain' | 'Hail' | 'Snow' | 'Acid Rain' | 'Eclipse' | 'Starstorm' | 'Sleet' | 'Windy' | 'Harsh Sunshine' | 'Heavy Rain' | 'Strong Winds';
...
export type TypeName = 'Normal' | 'Fighting' | 'Flying' | 'Poison' | 'Ground' | 'Rock' | 'Bug' | 'Ghost' | 'Steel' | 'Fire' | 'Water' | 'Grass' | 'Electric' | 'Psychic' | 'Ice' | 'Dragon' | 'Dark' | 'Fairy' | 'Cosmic' | '???';
