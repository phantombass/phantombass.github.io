...
export type Weather =
  | 'Sand' | 'Sun' | 'Rain' | 'Hail' | 'Snow' | 'Acid Rain' | 'Eclipse' | 'Starstorm' | 'Sleet' | 'Windy' | 'Harsh Sunshine' | 'Heavy Rain' | 'Strong Winds'  ;
...
export type TypeName =
  ...
  'Fire' | 'Water' | 'Grass' | 'Electric' | 'Psychic' | 'Ice' | 'Dragon' | 'Dark' | 'Fairy' | 'Cosmic' | '???';
