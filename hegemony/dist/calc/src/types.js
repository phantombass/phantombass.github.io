...
var XY = (0, util_1.extend)(true, {}, GSC, {
    '???': { Fairy: 1, Cosmic: 1 },
    Normal: { Fairy: 1, Cosmic: 1 },
    Grass: { Fairy: 1, Cosmic: 1 },
    Fire: { Fairy: 1, Cosmic: 0.5 },
    Water: { Fairy: 1, Cosmic: 0.5 },
    Electric: { Fairy: 1, Cosmic: 1 },
    Ice: { Fairy: 1, Cosmic: 2 },
    Flying: { Fairy: 1, Cosmic: 0.5 },
    Bug: { Fairy: 0.5, Cosmic: 1 },
    Poison: { Fairy: 2, Cosmic: 1 },
    Ground: { Fairy: 1, Cosmic: 1 },
    Rock: { Fairy: 1, Cosmic: 0.5 },
    Fighting: { Fairy: 0.5, Cosmic: 1 },
    Psychic: { Fairy: 1, Cosmic: 2 },
    Ghost: { Steel: 1, Fairy: 1, Cosmic: 1 },
    Dragon: { Fairy: 0, Cosmic: 1 },
    Dark: { Steel: 1, Fairy: 0.5, Cosmic: 1 },
    Steel: { Fairy: 2, Cosmic: 2 },
    Fairy: {
        '???': 1,
        Normal: 1,
        Grass: 1,
