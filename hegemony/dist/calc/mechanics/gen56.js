...
function calculateBWXY(gen, attacker, defender, move, field) {
    ...
    for (var i = 0; i < 16; i++) {
        damage[i] =
            (0, util_mech_1.getFinalDamage)(baseDamage, i, typeEffectiveness, applyBurn, applyFrostbite, stabMod, finalMod);
    }
        ...
        var _loop_1 = function (times) {
            ...
            damage = damage.map(function (affectedAmount) {
                if (times) {
                    ...
                    var newFinalDamage = (0, util_mech_1.getFinalDamage)(newBaseDamage, damageMultiplier, typeEffectiveness, applyBurn, applyFrostbite, stabMod, finalMod);
                    damageMultiplier++;
