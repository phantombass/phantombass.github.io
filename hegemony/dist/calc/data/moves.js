...
var XY_PATCH = {
    ...
    'Spacial Rend': { type: 'Cosmic' },
    'Aurora Beam': { type: 'Cosmic' },
    'Comet Punch': { type: 'Cosmic' },
    'Wish': { type: 'Cosmic' },
    'Diamond Storm': {
        bp: 100,
        type: 'Rock',
...
var SM_PATCH = {
    ...
    'Prismatic Laser': { bp: 160, type: 'Cosmic', category: 'Special', zp: 200 },
    'Psychic Fangs': {
        bp: 85,
        type: 'Psychic',
        makesContact: true,
...
var SV_PATCH = {
    ...
    'Aurora Beam': { isBeam: true },
    'Behemoth Blade': { isSlicing: true },
    'Blaze Kick': { isKicking: true },
    Blizzard: { isWind: true },
    'Brick Break': { isSlicing: true },
    'Bubble Beam': { isBeam: true },
    ...
    'Dual Chop': { isSlicing: true },
    'Dynamax Cannon': { isBeam: true },
    Eternabeam: { isBeam: true },
    'Fairy Wind': { isWind: true },
    'Flash Cannon': { isBeam: true },
    'Fleur Cannon': { isBeam: true },
    ...
    'Head Smash': { isHead: true },
    Headbutt: { isHead: true },
    'Heat Wave': { isWind: true },
    'High Jump Kick': { isKicking: true },
    Hurricane: { isWind: true },
    'Hyper Beam': { isBeam: true },
    'Ice Hammer': { isHammer: true },
    'Ice Beam': { isBeam: true },
    'Icy Wind': { isWind: true },
    'Iron Head': { isHead: true },
    'Jump Kick': { isKicking: true },
    'Karate Chop': { isSlicing: true },
    'Leaf Blade': { isSlicing: true },
    'Light of Ruin': { isBeam: true },
    'Low Kick': { isKicking: true },
    'Low Sweep': { isKicking: true },
    'Mega Kick': { isKicking: true },
    'Metal Claw': { isSlicing: true },
    'Meteor Beam': { isBeam: true },
    'Moongeist Beam': { isBeam: true },
    'Night Slash': { isSlicing: true },
    'Origin Pulse': { isBeam: true },
    'Petal Blizzard': { isWind: true },
    'Power Gem': { isBeam: true },
    'Psycho Cut': { isSlicing: true },
    'Psybeam': { isBeam: true },
    'Razor Leaf': { isSlicing: true },
    'Razor Shell': { isSlicing: true },
    'Rolling Kick': { isKicking: true },
    ...
    'Steel Beam': { isBeam: true },
    'Stomp': { isKicking: true },
    Tailwind: { isWind: true },
    'Techno Blast': { isBeam: true },
    'Thunderous Kick': { isKicking: true },
    'Tri Attack': { isBeam: true },
    'Triple Axel': { isKicking: true },
    'Triple Kick': { isKicking: true },
    'Trop Kick': { isKicking: true },
    Twister: { isWind: true },
    Whirlwind: { isWind: true },
    'Wood Hammer': { isHammer: true },
    ...
    'Comet Shards': { bp: 0, category: 'Status', type: 'Cosmic' },
    'Starstorm': { bp: 0, category: 'Status', type: 'Cosmic' },
    'Stellar Wind': { bp: 40, type: 'Cosmic', category: 'Special' },
